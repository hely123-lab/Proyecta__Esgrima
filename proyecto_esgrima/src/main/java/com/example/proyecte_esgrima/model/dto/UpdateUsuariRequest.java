...
public class UpdateUsuariRequest {
    ...
    public void setDataNaixement(LocalDate d)    { this.dataNaixement = d; }
    public String getSexe()                      { return sexe; }
    public void setSexe(String sexe)             { this.sexe = sexe; }
    public NivelEsgrimista getNivell()           { return nivell; }
    public void setNivell(NivelEsgrimista n)     { this.nivell = n; }
    public ArmaEsgrima getArmaPreferida()        { return armaPreferida; }
    public void setArmaPreferida(ArmaEsgrima a)  { this.armaPreferida = a; }
}
